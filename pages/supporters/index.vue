<template>
  <div id="index">
    <!-- gnb -->
    <global-nav-supporters :onScrolled="onScrolled" :auth="auth" />
    ...
    <div class="intro">
      <b-container fluid>
        <div class="px-2 px-md-4 px-lg-5">
          <img
            :src="require('@/assets/images/bg-supporters.png')"
            alt=""
            class="w-100"
          />
        </div>
...
#index {
  // min-height: 4000px;
  background-color: $supporters-green;
  // position: relative;
  // overflow: hidden;
  overflow-x: hidden;
  ...
  .header-nav {
    ...
    .nav-links {
      ...
      .link-item {
        font-weight: 700;
        .nav-link {
          border: 1px solid $supporters-orange;
